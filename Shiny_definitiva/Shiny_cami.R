                ...
                tags$div(
                  ...
                  checkboxGroupInput(
                    ...
                    selected = {
                      ...
                      if (!is.null(registro$`Consumo actual con Nafta`) && !is.na(registro$`Consumo actual con Nafta`) && registro$`Consumo actual con Nafta` == "Si") sustancias_seleccionadas <- c(sustancias_seleccionadas, "Nafta")
                      ...
                      if (!is.null(registro$`Consumo actual con Otra`) && !is.na(registro$`Consumo actual con Otra`) && registro$`Consumo actual con Otra` == "Si") sustancias_seleccionadas <- c(sustancias_seleccionadas, "Otra")
